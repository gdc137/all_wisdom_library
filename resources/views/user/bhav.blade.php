...
<head>
    ...
    <meta name="description" content="Start your development with HappyToHelp landing page.">
    <meta name="author" content="HappyToHelp">
    <title>HappyToHelp | Free Bootstrap 4.3.x template</title>
    <!-- font icons -->
...
<body data-spy="scroll" data-target=".navbar" data-offset="40" id="home">
                ...
                <div class="card">
                    <div class="card-header pt-0">
                        ...
                        <div class="blog-media mb-4">
                            <img src="{{ asset('user-assets/imgs/blog-6.jpg') }}" alt="" class="w-100">
                    ...
                    <div class="card-footer">
                        ...
                        <hr>
                        <div class="media">
                            <img src="{{ asset('user-assets/imgs/avatar-1.jpg') }}" class="mr-3 thumb-sm rounded-circle" alt="...">
                            <div class="media-body">
                                ...
                                <div class="media mt-5">
                                    <a class="mr-3" href="#">
                                    <img src="{{ asset('user-assets/imgs/avatar.jpg') }}" class="thumb-sm rounded-circle" alt="...">
                                    </a>
                        ...
                        <div class="media mt-5">
                            <img src="{{ asset('user-assets/imgs/avatar-2.jpg') }}" class="mr-3 thumb-sm rounded-circle" alt="...">
                            <div class="media-body">
                        ...
                        <div class="media mt-4">
                            <img src="{{ asset('user-assets/imgs/avatar-3.jpg') }}" class="mr-3 thumb-sm rounded-circle" alt="...">
                            <div class="media-body">
                ...
                <div class="row">                       
                        ...
                        <div class="card mb-5">
                            <div class="card-header p-0">                                   
                                <div class="blog-media">
                                    <img src="{{ asset('user-assets/imgs/blog-2.jpg') }}" alt="" class="w-100">
                    ...
                    <div class="col-md-6 col-lg-4">
                        <div class="card mb-5">
                            <div class="card-header p-0">                                   
                                <div class="blog-media">
                                    <img src="{{ asset('user-assets/imgs/blog-3.jpg') }}" alt="" class="w-100">
                    ...
                    <div class="col-md-6 col-lg-4 d-none d-lg-block">
                        <div class="card mb-5">
                            <div class="card-header p-0">                                   
                                <div class="blog-media">
                                    <img src="{{ asset('user-assets/imgs/blog-4.jpg') }}" alt="" class="w-100">
    ...
    <div class="instagram-wrapper mt-5">
        ...
        <a href="javascript:void(0)" class="insta-item">
            <img src="{{ asset('user-assets/imgs/insta-1.jpg') }}" alt="" class="w-100">
            <div class="overlay">
                <span>
        ...
        <a href="javascript:void(0)" class="insta-item">
            <img src="{{ asset('user-assets/imgs/insta-2.jpg') }}" alt="" class="w-100">
            <div class="overlay">
                <span>
                    <i class="ti-heart"></i> 23
                </span>
        ...
        <a href="javascript:void(0)" class="insta-item">
            <img src="{{ asset('user-assets/imgs/insta-3.jpg') }}" alt="" class="w-100">
            <div class="overlay">
                <span>
                    <i class="ti-heart"></i> 23
                </span>
        ...
        <a href="javascript:void(0)" class="insta-item">
            <img src="{{ asset('user-assets/imgs/insta-4.jpg') }}" alt="" class="w-100">
            <div class="overlay">
                <span>
                    <i class="ti-heart"></i> 23
                </span>
        ...
        <a href="javascript:void(0)" class="insta-item">
            <img src="{{ asset('user-assets/imgs/insta-5.jpg') }}" alt="" class="w-100">
            <div class="overlay">
                <span>
                    <i class="ti-heart"></i> 23
                </span>
        ...
        <a href="javascript:void(0)" class="insta-item">
            <img src="{{ asset('user-assets/imgs/insta-6.jpg') }}" alt="" class="w-100">
            <div class="overlay">
                <span>
                    <i class="ti-heart"></i> 23
                </span>
        ...
        <div class="container">
            <div class="row align-items-center justify-content-between">
                <div class="col-md-3 text-center text-md-left mb-3 mb-md-0">
                    <img src="{{ asset('user-assets/imgs/logo.svg') }}" alt="" class="logo">
                </div>
            ...
            <p class="border-top mb-0 mt-4 pt-3 small">&copy; <script>document.write(new Date().getFullYear())</script>, HappyToHelp Created By <a href="https://www.HappyToHelp.com" class="text-muted font-weight-bold" target="_blank">HappyToHelp.</a>  All rights reserved </p> 
        </div>      
    </footer>
    <!-- End of Page Footer -->
