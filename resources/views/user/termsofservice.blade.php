...
<head>
    ...
    <title>HappyToHelp | Components</title>
    <!-- font icons -->
        ...
        <table class="table table-borderless v-align-center">
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Fugiat explicabo ab sed voluptas odit hic obcaecati qui omnis.</p>
                    </td>
                </tr>
                <tr>
                    <td>
    ...
    <footer class="page-footer">
        <div class="container">
            <p class="border-top mb-0 mt-4 pt-3 small">&copy; <script>
                ...
                </script>, HappyToHelp Created By <a href="https://www.HappyToHelp.com" class="text-muted font-weight-bold" target="_blank">HappyToHelp.</a> All rights reserved </p>
        </div>
    </footer>
    <!-- End of Page Footer -->
